...
public interface Input extends UIElement {
    ...
    interface WithInputNewXPath extends UIElement {
        @FindBy( r + "label[contains(text(), '{{ label }}')]//following-sibling::div//input[last()]")
        Input inputLabel(@Param("label") String labelText);
    }
